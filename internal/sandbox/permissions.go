...
func DefaultPolicy() Policy {
	p := Policy{
		...
		Allow: []Rule{
			...
			{Op: "exec", Text: "python"},
			{Op: "exec", Text: "python *"},
			// Common shell utilities — the same "every dev has it, every project
			// needs it" bucket as go/node/python. Agents hit these constantly
			// for text processing, file ops, and pipeline plumbing.
			{Op: "exec", Text: "sed"},
			{Op: "exec", Text: "sed *"},
			{Op: "exec", Text: "awk"},
			{Op: "exec", Text: "awk *"},
			...
			{Op: "exec", Text: "which"},
			{Op: "exec", Text: "type"},
			{Op: "exec", Text: "command"},
			{Op: "exec", Text: "realpath"},
			{Op: "exec", Text: "realpath *"},
			{Op: "exec", Text: "dirname"},
			{Op: "exec", Text: "dirname *"},
			{Op: "exec", Text: "basename"},
			{Op: "exec", Text: "basename *"},
			{Op: "exec", Text: "readlink"},
			{Op: "exec", Text: "readlink *"},
			{Op: "exec", Text: "ln"},
			{Op: "exec", Text: "ln *"},
			{Op: "exec", Text: "zip"},
