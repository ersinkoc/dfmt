...
// EnsureProjectInitialized + writeProjectClaudeSettings tests live in
// internal/setup/projectinit_test.go now that the merge-safe project-init
// helper has moved out of `cli` to be reusable from `internal/client`.
